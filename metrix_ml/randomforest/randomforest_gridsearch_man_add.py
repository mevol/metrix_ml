...
class RandomForestGridSearch(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.man_add_only, 'randomforest_gridsearch.txt'), 'a') as text_file:
...
#stratified split of samples
  ...
  def forest_best_params(self):
    ...
    feature_importances_pandas(self.forest_clf_grid_new_man_add, self.X_man_add_train, 'man_add', self.man_add_only)
    ...
    write_pickle(self.forest_clf_grid_new_man_add, self.man_add_only, 'man_add')
    ...
    visualise_tree(self.forest_clf_grid_new_man_add, self.man_add_only, self.X_man_add_train.columns, 'man_add')
    ...
    basic_stats(self.forest_clf_grid_new_man_add, self.X_man_add_train, self.man_add_only)
  ...
  def analysis(self):
    ...
    prediction_probas(self.forest_clf_grid_new_man_add, self.X_man_add_train, self.y_train, self.X_man_add_test, self.y_test, self.y_pred_proba_man_add, self.y_train_CV_pred_proba_man_add, self.man_add_only, 'man_add')    
...
def run():
  ...
  random_forest_grid_search = RandomForestGridSearch(metrix, man_add_only, bbbb)

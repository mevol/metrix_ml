...
class RandomForestRandSearch(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.transform_features, 'randomforest_randomsearch.txt'), 'a') as text_file:
    ...
    metrix_transform_normal = metrix_transform[['MW_chain/No_atom_chain', 'RpimdiffI', 'MW_ASU/sites_ASU', 'MW_ASU/sites_ASU/solvent_content', 'Matth_coeff']].copy()
    
    metrix_transform_stratified = metrix_transform[['MW_chain/No_atom_chain', 'Matth_coeff', 'totalobservations', 'diffF', 'MW_ASU/sites_ASU', 'anomalousCC']].copy()
...
#stratified split of samples
  ...
  def forest_best_params(self):
    ...
    feature_importances_pandas(self.forest_clf_rand_new_transform, self.X_transform_train, 'transform', self.transform_features)
    ...
    write_pickle(self.forest_clf_rand_new_transform, self.transform_features, 'transform')
    ...
    visualise_tree(self.forest_clf_rand_new_transform, self.transform_features, self.X_transform_train.columns, 'transform')
    ...
    basic_stats(self.forest_clf_rand_new_transform, self.X_transform_train, self.transform_features)
  ...
  def analysis(self):
    ...
    prediction_probas(self.forest_clf_rand_new_transform, self.X_transform_train, self.y_train, self.X_transform_test, self.y_test, self.y_pred_proba_transform, self.y_train_CV_pred_proba_transform, self.transform_features, 'transform')    
...
def run():
  ...
  random_forest_rand_search = RandomForestRandSearch(metrix, transform_features, bbbb)

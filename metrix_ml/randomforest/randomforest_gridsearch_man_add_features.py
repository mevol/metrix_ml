...
class RandomForestGridSearch(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    metrix_man_add_normal = metrix_man_add[['RpimdiffI', 'totalobservations', 'Matth_coeff', 'sites_ASU', 'diffF']].copy()

    metrix_man_add_stratified = metrix_man_add[['totalobservations', 'Matth_coeff', 'anomalousCC', 'IoverSigma', 'diffF', 'sites_ASU']].copy()
...
#stratified split of samples
  ...
  def grid_search(self):
    ...
    param_grid = {"criterion": ["gini", "entropy"],#metric to judge reduction of impurity
                 ...
                 'max_features': [1, 2, 4, 6],#max number of features when splitting
  ...
  def forest_best_params(self):
    ...
    feature_importances_pandas(self.forest_clf_grid_new_man_add, self.X_man_add_train, 'man_add', self.man_add_features)
    ...
    write_pickle(self.forest_clf_grid_new_man_add, self.man_add_features, 'man_add')
    ...
    visualise_tree(self.forest_clf_grid_new_man_add, self.man_add_features, self.X_man_add_train.columns, 'man_add')
    ...
    basic_stats(self.forest_clf_grid_new_man_add, self.X_man_add_train, self.man_add_features)
  ...
  def analysis(self):
    ...
    prediction_probas(self.forest_clf_grid_new_man_add, self.X_man_add_train, self.y_train, self.X_man_add_test, self.y_test, self.y_pred_proba_man_add, self.y_train_CV_pred_proba_man_add, self.man_add_features, 'man_add')    
...
def run():
  ...
  random_forest_grid_search = RandomForestGridSearch(metrix, man_add_features, bbbb)

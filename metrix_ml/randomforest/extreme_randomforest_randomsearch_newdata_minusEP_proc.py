...
#stratified split of samples
  ...
  def rand_search(self):
    ...
    extra_clf_rand = ExtraTreesClassifier(random_state=100, max_depth=1)
  ...
  def forest_best_params(self):
    ...
    self.extra_clf_rand_new_transform = ExtraTreesClassifier(**self.best_params_transform, random_state=100, max_depth=1)

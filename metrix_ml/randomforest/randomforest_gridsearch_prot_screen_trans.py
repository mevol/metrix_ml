...
class RandomForestGridSearch(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.prot_screen_trans_only, 'randomforest_gridsearch.txt'), 'a') as text_file:
...
#stratified split of samples
  ...
  def forest_best_params(self):
    ...
    feature_importances_pandas(self.forest_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train, 'prot_screen_trans', self.prot_screen_trans_only)
    ...
    write_pickle(self.forest_clf_grid_new_prot_screen_trans, self.prot_screen_trans_only, 'prot_screen_trans')
    ...
    visualise_tree(self.forest_clf_grid_new_prot_screen_trans, self.prot_screen_trans_only, self.X_prot_screen_trans_train.columns, 'prot_screen_trans')
    ...
    basic_stats(self.forest_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train, self.prot_screen_trans_only)
  ...
  def analysis(self):
    ...
    prediction_probas(self.forest_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train, self.y_train, self.X_prot_screen_trans_test, self.y_test, self.y_pred_proba_prot_screen_trans, self.y_train_CV_pred_proba_prot_screen_trans, self.prot_screen_trans_only, 'prot_screen_trans')  
...
def run():
  ...
  random_forest_grid_search = RandomForestGridSearch(metrix, prot_screen_trans_only, bbbb)

...
class DecisionTreeRandomSearchManAdd(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.man_add_only, 'decisiontree_randomsearch.txt'), 'a') as text_file:
...
#stratified split of samples
  ...
  def rand_search(self):
    ...
    param_rand = {"criterion": ["gini", "entropy"],#metric to judge reduction of impurity
                  'max_features': randint(2, 29),#max number of features when splitting
  ...
  def tree_best_params(self):
    ...
    plot_features(self.tree_clf_rand_new_man_add, self.X_man_add_train.columns, self.man_add_only)
    ...
    write_pickle(self.tree_clf_rand_new_man_add, self.man_add_only, 'man_add')
    ...
    visualise_tree(self.tree_clf_rand_new_man_add, self.man_add_only, self.X_man_add_train.columns, 'man_add')
    ...
    basic_stats(self.tree_clf_rand_new_man_add, self.X_man_add_train, self.man_add_only)
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_rand_new_man_add, self.X_man_add_train, self.y_train, self.X_man_add_test, self.y_test, self.y_pred_proba_man_add, self.y_train_CV_pred_proba_man_add, self.man_add_only, 'man_add_only')    
...
def run():
  ...
  decision_tree_random_search_man_add = DecisionTreeRandomSearchManAdd(metrix, man_add_only, bbbb)

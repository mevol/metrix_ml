...
class DecisionTreeBagGridSearch(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.man_add_features, 'decisiontree_bag_gridsearch.txt'), 'a') as text_file:
      text_file.write('Preparing input data as metrix_man_add with following attributes %s \n' %(attr_man_add))
    
    metrix_man_add_normal = metrix_man_add[['diffF', 'sites_ASU', 'Matth_coeff', 'totalobservations']].copy()
    metrix_man_add_stratified = metrix_man_add[['RpimdiffI', 'totalobservations', 'Matth_coeff', 'MW_chain']].copy()
...
#stratified split of samples
  ...
  def tree_best_params(self):
    ...
    feature_importances_pandas(self.tree_clf_grid_bag_new_man_add, self.X_man_add_train, 'man_add', self.man_add_features)
    ...
    write_pickle(self.tree_clf_grid_bag_new_man_add, self.man_add_features, 'man_add')
    ...
    visualise_tree(self.tree_clf_grid_bag_new_man_add, self.man_add_features, self.X_man_add_train.columns, 'man_add')
    ...
    basic_stats(self.tree_clf_grid_bag_new_man_add, self.X_man_add_train, self.man_add_features)
  ...
  def predict(self):
    ...
    with open(os.path.join(self.man_add_features, 'decisiontree_bag_randomsearch.txt'), 'a') as text_file:
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_grid_bag_new_man_add, self.X_man_add_train, self.y_train, self.X_man_add_test, self.y_test, self.y_pred_proba_man_add, self.y_train_CV_pred_proba_man_add, self.man_add_features, 'man_add')    
...
def run():
  ...
  decision_tree_bag_grid_search = DecisionTreeBagGridSearch(metrix, man_add_features, bbbb)

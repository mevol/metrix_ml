...
class RandomForestAdaRandSearch(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.transform_only, 'randomforest_ada_randomsearch.txt'), 'a') as text_file:
...
#stratified split of samples
  ...
  def forest_best_params(self):
    ...
    feature_importances_pandas(self.tree_clf_rand_ada_new_transform, self.X_transform_train, 'transform', self.transform_only)
    ...
    write_pickle(self.tree_clf_rand_ada_new_transform, self.transform_only, 'transform')
    ...
    visualise_tree(self.tree_clf_rand_ada_new_transform, self.transform_only, self.X_transform_train.columns, 'transform')
    ...
    basic_stats(self.tree_clf_rand_ada_new_transform, self.X_transform_train, self.transform_only)
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_rand_ada_new_transform, self.X_transform_train, self.y_train, self.X_transform_test, self.y_test, self.y_pred_proba_transform, self.y_train_CV_pred_proba_transform, self.transform_only, 'transform')    
...
def run():
  ...
  random_forest_ada_rand_search = RandomForestAdaRandSearch(metrix, transform_only, bbbb)

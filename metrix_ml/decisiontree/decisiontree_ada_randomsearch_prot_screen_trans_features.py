...
class RandomForestAdaRandSearch(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.prot_screen_trans_features, 'randomforest_ada_randomsearch.txt'), 'a') as text_file:
    ...
    metrix_prot_screen_trans_normal = metrix_prot_screen_trans[['sites_ASU', 'MW_ASU']].copy()

    metrix_prot_screen_trans_stratified = metrix_prot_screen_trans[['sites_ASU', 'MW_ASU']].copy()
...
#stratified split of samples
  ...
  def forest_best_params(self):
    ...
    self.tree_clf_rand_ada_new_prot_screen_trans = AdaBoostClassifier(
                                ...
                                algorithm ="SAMME.R", learning_rate=0.01, random_state=5, n_estimators=500)
    ...
    feature_importances_pandas(self.tree_clf_rand_ada_new_prot_screen_trans, self.X_prot_screen_trans_train, 'prot_screen_trans', self.prot_screen_trans_features)
    ...
    write_pickle(self.tree_clf_rand_ada_new_prot_screen_trans, self.prot_screen_trans_features, 'prot_screen_trans')
    ...
    visualise_tree(self.tree_clf_rand_ada_new_prot_screen_trans, self.prot_screen_trans_features, self.X_prot_screen_trans_train.columns, 'prot_screen_trans')
    ...
    basic_stats(self.tree_clf_rand_ada_new_prot_screen_trans, self.X_prot_screen_trans_train, self.prot_screen_trans_features)
  ...
  def predict(self):
    ...
    #self.y_pred_prot_screen_trans = self.tree_clf_rand_ada_new_prot_screen_trans.predict(self.X_prot_screen_trans_test)
    self.y_pred_prot_screen_trans = self.tree_clf_rand_ada_new_prot_screen_trans.predict(self.X_prot_screen_trans_test)
    self.y_pred_proba_prot_screen_trans = self.tree_clf_rand_ada_new_prot_screen_trans.predict_proba(self.X_prot_screen_trans_test)
    with open(os.path.join(self.prot_screen_trans_features, 'randomforest_ada_randomsearch.txt'), 'a') as text_file:
    ...
    self.y_train_CV_pred_prot_screen_trans = cross_val_predict(self.tree_clf_rand_ada_new_prot_screen_trans, self.X_prot_screen_trans_train, self.y_train, cv=10)
    self.y_train_CV_pred_proba_prot_screen_trans = cross_val_predict(self.tree_clf_rand_ada_new_prot_screen_trans, self.X_prot_screen_trans_train, self.y_train, cv=10, method='predict_proba')
    with open(os.path.join(self.prot_screen_trans_features, 'randomforest_ada_randomsearch.txt'), 'a') as text_file:
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_rand_ada_new_prot_screen_trans, self.X_prot_screen_trans_train, self.y_train, self.X_prot_screen_trans_test, self.y_test, self.y_pred_proba_prot_screen_trans, self.y_train_CV_pred_proba_prot_screen_trans, self.prot_screen_trans_features, 'prot_screen_trans')    
...
def run():
  ...
  random_forest_ada_rand_search = RandomForestAdaRandSearch(metrix, prot_screen_trans_features, bbbb)

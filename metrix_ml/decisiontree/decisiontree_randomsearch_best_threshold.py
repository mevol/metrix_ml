...
#stratified split of samples
  ...
  def tree_best_params(self):
    ...
    self.tree_clf_rand_new_transform = DecisionTreeClassifier(
                                       criterion='entropy',
                                       max_depth=8,
                                       max_features=2,
                                       max_leaf_nodes=10,
  ...
  def predict(self):
    ...
    prediction_stats(self.y_test, self.y_pred_adj, self.newdata_minusEP)
  ...
  def analysis(self):
    ...
    def conf_mat(y_test, y_train, y_pred, y_train_pred, directory):
      ...
      def draw_conf_mat(matrix, directory, name):
        ...
        plt.ylabel('True')
        plt.savefig(os.path.join(directory, 'confusion_matrix_tree_rand_'+name+datestring+'.png'), dpi=600)
        plt.close()
    ...
    conf_mat(self.y_test, self.y_train, self.y_pred_adj, self.y_train_CV_pred_adj, self.newdata_minusEP)

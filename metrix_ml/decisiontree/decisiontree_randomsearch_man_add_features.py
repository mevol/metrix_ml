...
class DecisionTreeRandomSearchManAdd(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    attr_man_add_normal = ['anomalousCC', 'wilsonbfactor', 'diffF']

    attr_man_add_stratified = ['anomalousCC', 'totalobservations', 'RpimdiffI', 'Matth_coeff']
    
    
    metrix_man_add = self.metrix[attr_man_add_stratified]

    with open(os.path.join(self.man_add_features, 'decisiontree_randomsearch.txt'), 'a') as text_file:
...
#stratified split of samples
  ...
  def tree_best_params(self):
    ...
    plot_features(self.tree_clf_rand_new_man_add, self.X_man_add_train.columns, self.man_add_features)
    ...
    write_pickle(self.tree_clf_rand_new_man_add, self.man_add_features, 'man_add')
    ...
    visualise_tree(self.tree_clf_rand_new_man_add, self.man_add_features, self.X_man_add_train.columns, 'man_add')
    ...
    basic_stats(self.tree_clf_rand_new_man_add, self.X_man_add_train, self.man_add_features)
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_rand_new_man_add, self.X_man_add_train, self.y_train, self.X_man_add_test, self.y_test, self.y_pred_proba_man_add, self.y_train_CV_pred_proba_man_add, self.man_add_features, 'man_add_features')    
...
def run():
  ...
  decision_tree_random_search_man_add = DecisionTreeRandomSearchManAdd(metrix, man_add_features, bbbb)

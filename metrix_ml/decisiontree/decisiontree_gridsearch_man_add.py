...
class DecisionTreeGridSearchManAdd(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.man_add_only, 'decisiontree_gridsearch.txt'), 'a') as text_file:
...
#    feature_importances_pandas(self.tree_clf_grid_new_database, self.X_database_train, 'database', self.database)      
    ...
    plot_features(self.tree_clf_grid_new_man_add, self.X_man_add_train.columns, self.man_add_only)
    ...
    write_pickle(self.tree_clf_grid_new_man_add, self.man_add_only, 'man_add')
    ...
    visualise_tree(self.tree_clf_grid_new_man_add, self.man_add_only, self.X_man_add_train.columns, 'man_add')
    ...
    basic_stats(self.tree_clf_grid_new_man_add, self.X_man_add_train, self.man_add_only)
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_grid_new_man_add, self.X_man_add_train, self.y_train, self.X_man_add_test, self.y_test, self.y_pred_proba_man_add, self.y_train_CV_pred_proba_man_add, self.man_add_only, 'man_add')    
...
def run():
  ...
  decision_tree_grid_search_man_add = DecisionTreeGridSearchManAdd(metrix, man_add_only, bbbb)

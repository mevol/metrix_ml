...
class DecisionTreeRandomSearchProtScreenTrans(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.prot_screen_trans_only, 'decisiontree_randomsearch.txt'), 'a') as text_file:
...
#stratified split of samples
  ...
  def tree_best_params(self):
    ...
    plot_features(self.tree_clf_rand_new_prot_screen_trans, self.X_prot_screen_trans_train.columns, self.prot_screen_trans_only)
    ...
    write_pickle(self.tree_clf_rand_new_prot_screen_trans, self.prot_screen_trans_only, 'prot_screen_trans')
    ...
    visualise_tree(self.tree_clf_rand_new_prot_screen_trans, self.prot_screen_trans_only, self.X_prot_screen_trans_train.columns, 'prot_screen_trans')
    ...
    basic_stats(self.tree_clf_rand_new_prot_screen_trans, self.X_prot_screen_trans_train, self.prot_screen_trans_only)
...
def run():
  ...
  decision_tree_random_search_prot_screen_trans = DecisionTreeRandomSearchProtScreenTrans(metrix, prot_screen_trans_only, bbbb)

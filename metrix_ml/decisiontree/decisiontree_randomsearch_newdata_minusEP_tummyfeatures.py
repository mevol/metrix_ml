...
#stratified split of samples
  ...
  def rand_search(self):
    ...
    param_rand = {"criterion": ["gini", "entropy"],#metric to judge reduction of impurity
                  ...
                  'max_features': randint(2, 12),#max number of features when splitting
  ...
  def tree_best_params(self):
    ...
    def plot_features(clf, attr, directory):
      ...
      skplt.estimators.plot_feature_importances(clf, feature_names=attr, x_tick_rotation=60, max_num_features=15, figsize=(25, 25))
      plt.tight_layout()

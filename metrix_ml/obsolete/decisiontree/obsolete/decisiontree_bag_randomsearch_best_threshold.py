...
#stratified split of samples
  ...
  def tree_best_params(self):
    ...
    clf2 = DecisionTreeClassifier(criterion='entropy',
                                  ...
                                  min_samples_split=2,
                                  random_state= 0)
    self.tree_clf_rand_bag_new_transform = BaggingClassifier(clf2, n_estimators=6509, n_jobs=-1, bootstrap=True, random_state=100)
  ...
  def analysis(self):
    ...
    def conf_mat(y_test, y_train, y_pred, y_train_pred, directory):
      ...
      def draw_conf_mat(matrix, directory, name):
        ...
        plt.ylabel('True')
        plt.savefig(os.path.join(directory, 'confusion_matrix_tree_rand_bag_'+name+datestring+'.png'), dpi=600)
        plt.close()

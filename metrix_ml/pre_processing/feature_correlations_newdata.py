...
class FeatureCorrelations(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    '''
    print('*' *80)
    print('*    Preparing input dataframes metrix_newdata')
    print('*' *80)
    ...
    with open(os.path.join(self.newdata, 'feature_correlations.txt'), 'a') as text_file:
...
#stratified split of samples
    ...
    self.X_newdata_transform_train_ordered = self.X_newdata_transform_train[
                         ['IoverSigma', 'cchalf', 'RmergediffI', 'RmergeI', 'RmeasI',
                          ...
                          'volume_wilsonB_highres', 'EP_sg_number', 'CCweak', 'CCall',
                          'CFOM', 'CCall-CCweak', 'CCweak/CCall', 'res_built_o',
                          'res_built_i', 'No_frag_o', 'No_frag_i', 'ratio_res_frag_o',
                          'ratio_res_frag_i']]                              
  ...
  def plotting(self):      
    ...
    calculate_pearson_cc(self.X_newdata_transform_train_ordered, 'newdata', self.newdata)
    ...
    correlation_pvalue(self.X_newdata_transform_train_ordered, 'newdata', self.newdata)
    ...
    plot_scatter_matrix(self.X_newdata_transform_train_ordered, 'newdata', self.newdata)
    ...
    feature_conf_mat(self.X_newdata_transform_train_ordered, 'newdata', self.newdata)
...
def run():
  ...
  feature_correlations = FeatureCorrelations(metrix, newdata, bbbb)

...
class CreatePolynomialFeatures(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.newdata, 'polynomial_features.txt'), 'a') as text_file:
...
###############################################################################
  ...
  def polynomials(self):
    def get_polynomials(X_train, y_train):
      ...
      feature_importances_best_25(self.feature_importances_ls[:25], self.newdata)  
      ...
      feature_importances_pandas(self.forest_clf_poly, self.X_newdata_train_poly, feature_names, self.newdata)
      ...
      feature_importances_pandas2(self.forest_clf_poly, self.X_newdata_train_poly, feature_names, self.newdata)
...
def run():
  ...
  polynomial_features = CreatePolynomialFeatures(metrix, newdata, bbbb)

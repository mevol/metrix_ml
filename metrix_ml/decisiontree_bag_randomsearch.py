...
from tbx import feature_importances_error_bars, confusion_matrix_and_stats, print_to_consol
...
class TreeBagBoostRandSearch():
    ''' A class to conduct a randomised search and training for best parameters for a
        decision tree classifier with Bagging; the following steps are executed:

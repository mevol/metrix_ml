...
class TreeBagBoostRandSearch():
    ''' A class to conduct a randomised search and training for best parameters for a
        decision tree with Bagging; the following steps are executed:
    ...
    def randomised_search(self):
        ...
        logging.info(f'Initialised decision tree and Bagging using balanced class weights')
        ...
        logging.info(f'Running randomised search for best patameters of a decision tree \n'
                     f'with Bagging scoring is accuracy \n'

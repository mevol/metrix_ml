...
class DecisionTreeGridSearchProtScreenTrans(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    metrix_prot_screen_trans_features_normal = metrix_prot_screen_trans[['MW_ASU/sites_ASU', 'MW_chain', 'MW_chain/No_atom_chain', 'highreslimit']].copy()
...
#    feature_importances_pandas(self.tree_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train, 'prot_screen_trans', self.prot_screen_trans)      
    ...
    plot_features(self.tree_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train.columns, self.prot_screen_trans_features)
    ...
    write_pickle(self.tree_clf_grid_new_prot_screen_trans, self.prot_screen_trans_features, 'prot_screen_trans')
    ...
    visualise_tree(self.tree_clf_grid_new_prot_screen_trans, self.prot_screen_trans_features, self.X_prot_screen_trans_train.columns, 'prot_screen_trans')
    ...
    basic_stats(self.tree_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train, self.prot_screen_trans_features)
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train, self.y_train, self.X_prot_screen_trans_test, self.y_test, self.y_pred_proba_prot_screen_trans, self.y_train_CV_pred_proba_prot_screen_trans, self.prot_screen_trans_features, 'prot_screen_trans')  
...
def run():
  ...
  decision_tree_grid_search_prot_screen_trans = DecisionTreeGridSearchProtScreenTrans(metrix, prot_screen_trans_features, bbbb)

...
#stratified split of samples
  ...
  def svm_best_params(self):
    ...
    #print(cv)
    cv.fit(['diffI', 'anomalousCC', 'MW_ASU_sites_ASU', 'lowreslimit', 'anomalousslope', 'diffF', 'MW_ASU_sites_ASU_solvent_content',
    'Matth_coeff', 'sg_number', 'cchalf', 'anomalouscompl', 'solvent_content'])
    #print(cv)                  
    ...
    def plot_coefficients(coef, feature_names, top_features=12):

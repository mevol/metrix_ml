...
#stratified split of samples
  ...
  def tree_best_params(self):
    ...
    feature_importances_pandas(self.tree_clf_rand_bag_new_prot_screen_trans, self.X_prot_screen_trans_train, 'prot_screen_trans', self.prot_screen_trans_only)
    ...
    write_pickle(self.tree_clf_rand_bag_new_prot_screen_trans, self.prot_screen_trans_only, 'prot_screen_trans')
    ...
    visualise_tree(self.tree_clf_rand_bag_new_prot_screen_trans, self.prot_screen_trans_only, self.X_prot_screen_trans_train.columns, 'prot_screen_trans')
    ...
    basic_stats(self.tree_clf_rand_bag_new_prot_screen_trans, self.X_prot_screen_trans_train, self.prot_screen_trans_only)
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_rand_bag_new_prot_screen_trans, self.X_prot_screen_trans_train, self.y_train, self.X_prot_screen_trans_test, self.y_test, self.y_pred_proba_prot_screen_trans, self.y_train_CV_pred_proba_prot_screen_trans, self.prot_screen_trans_only, 'prot_screen_trans')  
...
def run():
  ...
  decision_tree_bag_rand_search = DecisionTreeBagRandomSearch(metrix, prot_screen_trans_only, bbbb)

...
class DecisionTreeGridSearchDatabase(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    attr_database_normal = ['IoverSigma', 'anomalousmulti', 'lowreslimit',
...
#stratified split of samples
  ...
  def tree_best_params(self):
    ...
    plot_features(self.tree_clf_grid_new_database, self.X_database_train.columns, self.database_features)
    ...
    write_pickle(self.tree_clf_grid_new_database, self.database_features, 'database')
    ...
    visualise_tree(self.tree_clf_grid_new_database, self.database_features, self.X_database_train.columns, 'database')
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_grid_new_database, self.X_database_train, self.y_train, self.X_database_test, self.y_test, self.y_pred_proba_database, self.y_train_CV_pred_proba_database, self.database_features, 'database')    
...
def run():
  ...
  decision_tree_grid_search_database = DecisionTreeGridSearchDatabase(metrix, database_features, bbbb)

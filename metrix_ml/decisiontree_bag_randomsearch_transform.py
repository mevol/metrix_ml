...
#stratified split of samples
  ...
  def tree_best_params(self):
    ...
    feature_importances_pandas(self.tree_clf_rand_bag_new_transform, self.X_transform_train, 'transform', self.transform_only)
    ...
    write_pickle(self.tree_clf_rand_bag_new_transform, self.transform_only, 'transform')
    ...
    visualise_tree(self.tree_clf_rand_bag_new_transform, self.transform_only, self.X_transform_train.columns, 'transform')
    ...
    basic_stats(self.tree_clf_rand_bag_new_transform, self.X_transform_train, self.transform_only)
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_rand_bag_new_transform, self.X_transform_train, self.y_train, self.X_transform_test, self.y_test, self.y_pred_proba_transform, self.y_train_CV_pred_proba_transform, self.transform_only, 'transform')    
...
def run():
  ...
  decision_tree_bag_rand_search = DecisionTreeBagRandomSearch(metrix, transform_only, bbbb)

...
class DecisionTreeBagRandomSearch(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    metrix_man_add_normal = metrix_man_add[['diffF', 'anomalousCC', 'wilsonbfactor']].copy()

    metrix_man_add_stratified = metrix_man_add[['RpimdiffI', 'Matth_coeff', 'totalobservations', 'anomalousCC']].copy()
...
#stratified split of samples
  ...
  def tree_best_params(self):
    ...
    feature_importances_pandas(self.tree_clf_rand_bag_new_man_add, self.X_man_add_train, 'man_add', self.man_add_features)
    ...
    write_pickle(self.tree_clf_rand_bag_new_man_add, self.man_add_features, 'man_add')
    ...
    visualise_tree(self.tree_clf_rand_bag_new_man_add, self.man_add_features, self.X_man_add_train.columns, 'man_add')
    ...
    basic_stats(self.tree_clf_rand_bag_new_man_add, self.X_man_add_train, self.man_add_features)
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_rand_bag_new_man_add, self.X_man_add_train, self.y_train, self.X_man_add_test, self.y_test, self.y_pred_proba_man_add, self.y_train_CV_pred_proba_man_add, self.man_add_features, 'man_add')    
...
def run():
  ...
  decision_tree_bag_rand_search = DecisionTreeBagRandomSearch(metrix, man_add_features, bbbb)

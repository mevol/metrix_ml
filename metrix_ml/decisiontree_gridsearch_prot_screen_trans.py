...
class DecisionTreeGridSearchProtScreenTrans(object):
  ...
  def prepare_metrix_data(self):
    ...
    ******
    ...
    with open(os.path.join(self.prot_screen_trans_only, 'decisiontree_gridsearch.txt'), 'a') as text_file:
...
#    feature_importances_pandas(self.tree_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train, 'prot_screen_trans', self.prot_screen_trans)      
    ...
    plot_features(self.tree_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train.columns, self.prot_screen_trans_only)
    ...
    write_pickle(self.tree_clf_grid_new_prot_screen_trans, self.prot_screen_trans_only, 'prot_screen_trans')
    ...
    visualise_tree(self.tree_clf_grid_new_prot_screen_trans, self.prot_screen_trans_only, self.X_prot_screen_trans_train.columns, 'prot_screen_trans')
    ...
    basic_stats(self.tree_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train, self.prot_screen_trans_only)
  ...
  def analysis(self):
    ...
    prediction_probas(self.tree_clf_grid_new_prot_screen_trans, self.X_prot_screen_trans_train, self.y_train, self.X_prot_screen_trans_test, self.y_test, self.y_pred_proba_prot_screen_trans, self.y_train_CV_pred_proba_prot_screen_trans, self.prot_screen_trans_only, 'prot_screen_trans')  
...
def run():
  ...
  decision_tree_grid_search_prot_screen_trans = DecisionTreeGridSearchProtScreenTrans(metrix, prot_screen_trans_only, bbbb)
